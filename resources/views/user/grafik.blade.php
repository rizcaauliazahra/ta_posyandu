@extends('layouts.app', ['title' => 'Grafik Pertumbuhan'])

@section('content')
@if(auth()->user()->isAdmin())
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0 text-gray-800">Grafik Pertumbuhan</h1>
...
<div class="d-flex justify-content-end mb-3">
    <div class="form-check form-switch">
        <input class="form-check-input" type="checkbox" id="globalToggleSdLines" checked>
        <label class="form-check-label fw-bold text-secondary" for="globalToggleSdLines">Tampilkan Garis Standar Deviasi</label>
    </div>
</div>
<div class="row g-4 mb-4" id="chartContainersWrapper">
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="hc-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="hc-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        </div>
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="hc-wrap" style="min-width: 900px; height: 650px; position: relative;">
    ...
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="w-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="w-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="w-wrap" style="min-width: 900px; height: 650px; position: relative;"><canvas id="weightChart"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="h-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="h-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="h-wrap" style="min-width: 900px; height: 650px; position: relative;"><canvas id="heightChart"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="wl-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="wl-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="wl-wrap" style="min-width: 900px; height: 650px; position: relative;"><canvas id="weightLengthChart"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="bmi-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="bmi-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="bmi-wrap" style="min-width: 900px; height: 650px; position: relative;"><canvas id="bmiChart"></canvas></div></div>
    </div></div></div>
@if($child->ageMonths() >= 24)
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="w2-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="w2-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="w2-wrap" style="min-width: 900px; height: 650px; position: relative;"><canvas id="weightChart2460"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="h2-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="h2-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="h2-wrap" style="min-width: 900px; height: 650px; position: relative;"><canvas id="heightChart2460"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="wh2-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="wh2-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="wh2-wrap" style="min-width: 900px; height: 650px; position: relative;"><canvas id="weightHeightChart2460"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
            ...
            <div class="btn-group btn-group-sm"><button class="btn btn-outline-secondary btn-zoom-out" data-target="bmi2-wrap"><i class="bi bi-dash"></i></button><button class="btn btn-outline-secondary btn-zoom-in" data-target="bmi2-wrap"><i class="bi bi-plus"></i></button></div>
        </div>
        
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="bmi2-wrap" style="min-width: 900px; height: 650px; position: relative;"><canvas id="bmiChart2460"></canvas></div></div>
    </div></div></div>
@endif
</div>
@endsection
...
const isFemale = {{ $child->gender === 'female' ? 'true' : 'false' }};
const sdDatasetsW = [];
if (isFemale) {
    const sdsW = [
        ...
        chart.data.datasets.forEach((dataset, i) => {
            if (dataset.label && dataset.label.startsWith('SD ')) {
                ...
                if (chart.isDatasetVisible(i) && meta.data.length > 0) {
                    ...
                    let targetPoint = meta.data[0];
                    for(let j=0; j<meta.data.length; j++) {
                        let xVal = dataset.data[j].x;
                        if(xVal <= maxX) {
                            targetPoint = meta.data[j];
                        } else {
                            break;
                        }
                    }
                    ...
                    ctx.fillText(labelText, chart.chartArea.right + 5, targetPoint.y);
                    ctx.restore();
                }
            }
        });
...
const weightChart = new Chart(document.getElementById('weightChart'), {
    ...
    options: { 
        ...
        scales: { 
            x: makeXAxisW(), 
            y: makeYAxisW(), yRight: { ...makeYAxisW(), position: 'right', title: { display: false }, grid: { ...makeYAxisW().grid, drawOnChartArea: false }, ticks: { ...makeYAxisW().ticks, padding: 25 } } 
        },
        plugins: {
            legend: {
                labels: {
                    filter: function(item, data) {
                        ...
                        if (dataset.label && dataset.label.startsWith('SD ')) {
                            const toggle = document.getElementById('globalToggleSdLines');
                ...
                callbacks: {
                    ...
                    label: function(context) {
                        if (context.dataset.label === 'Berat Badan (kg)') {
                            ...
                            if (isFemale) {
                                y_minus3 = getInterpolatedWeightFemale(m, -3);
                                y_minus2 = getInterpolatedWeightFemale(m, -2);
                                y_plus1 = (getInterpolatedWeightFemale(m, 0) + getInterpolatedWeightFemale(m, 2)) / 2;
                            } else {
                                const median = getMedianW(m);
                                const sdVal = 0.4 + (m * 0.035);
    ...
    plugins: [customBgPluginW, sdLabelsPluginW]
});
...
const heightChart = new Chart(document.getElementById('heightChart'), {
    ...
    options: { 
        ...
        scales: { 
            x: makeXAxisH(), 
            y: makeYAxisH(), yRight: { ...makeYAxisH(), position: 'right', title: { display: false }, grid: { ...makeYAxisH().grid, drawOnChartArea: false }, ticks: { ...makeYAxisH().ticks, padding: 25 } } 
        },
        plugins: {
            legend: {
                labels: {
            ...
            tooltip: {
                ...
                callbacks: {
                    ...
                    label: function(context) {
                        if (context.dataset.label === 'Panjang Badan (cm)') {
                            const m = context.parsed.x;
                            const val = context.parsed.y;
                            let y_minus3, y_minus2, y_plus3;
                            if (isFemale) {
                                y_minus3 = getInterpolatedHeightFemale(m, -3);
                                y_minus2 = getInterpolatedHeightFemale(m, -2);
                                y_plus3 = getInterpolatedHeightFemale(m, 3);
                            } else {
                                const median = getMedianH(m);
                                const sdVal = 1.9 + (m * 0.054);
                                y_minus3 = median + (-3 * sdVal);
                                y_minus2 = median + (-2 * sdVal);
    ...
    plugins: [customBgPluginH, sdLabelsPluginH]
});
...
const headCircumferenceChart = new Chart(document.getElementById('headCircumferenceChart'), {
    type:'line', 
    data:{
        datasets:[
            ...sdDatasets,
            {
                label:'Lingkar Kepala Anak (cm)', 
                data:@json($headCircumferenceData), 
                borderColor: '#334155', 
                backgroundColor: 'rgba(51, 65, 85, 0.2)', 
                borderWidth: 3,
                tension: 0, 
    ...
    options: { 
        ...
        scales: { 
            x: makeXAxisHc(), 
            y: makeYAxisHc(), yRight: { ...makeYAxisHc(), position: 'right', title: { display: false }, grid: { ...makeYAxisHc().grid, drawOnChartArea: false }, ticks: { ...makeYAxisHc().ticks, padding: 25 } } 
        },
        plugins: {
            legend: {
                labels: {
            ...
            tooltip: {
                ...
                callbacks: {
                    ...
                    label: function(context) {
                        if (context.dataset.label === 'Lingkar Kepala Anak (cm)') {
                            const m = context.parsed.x;
                            const val = context.parsed.y;
                            let y_plus2, y_minus2;
                            if (isFemale) {
                                y_plus2 = getInterpolatedHcFemale(m, 2);
                                y_minus2 = getInterpolatedHcFemale(m, -2);
                            } else {
                                y_plus2 = getMedianMale(m) + (2 * (1.15 + m * 0.005));
                                y_minus2 = getMedianMale(m) + (-2 * (1.15 + m * 0.005));
                            }
                            let status = "Normal";
                            if (val > y_plus2) status = "Makrosefali";
                            else if (val < y_minus2) status = "Mikrosefali";
                            
                            return [
                                `Lingkar Kepala: ${val} cm`,
                                `Kesimpulan: ${status}`
                            ];
                        }
                        return context.dataset.label + ': ' + context.parsed.y;
    ...
    plugins: [customBgPlugin, sdLabelsPlugin]
});
...
const weightLengthChart = new Chart(document.getElementById('weightLengthChart'), {
    type:'line', 
    data:{
        datasets:[
            ...sdDatasetsWL,
    ...
    options: { 
        ...
        scales: { 
            x: makeXAxisWL(),
            y: makeYAxisWL(), yRight: { ...makeYAxisWL(), position: 'right', title: { display: false }, grid: { ...makeYAxisWL().grid, drawOnChartArea: false }, ticks: { ...makeYAxisWL().ticks, padding: 25 } } 
        },
        plugins: {
            legend: {
                labels: {
            ...
            tooltip: {
                ...
                callbacks: {
                    title: function(context) {
                        if (context && context.length > 0) {
                            return `Panjang Badan (cm): ${context[0].parsed.x}`;
                        }
                        return '';
                    },
                    label: function(context) {
                        if (context.dataset.label === 'Berat Badan (kg)') {
                            ...
                            if (isFemale) {
                                y_minus3 = getInterpolatedWLFemale(l, -3);
                                y_minus2 = getInterpolatedWLFemale(l, -2);
                                y_plus1 = getInterpolatedWLFemale(l, 1);
                                y_plus2 = getInterpolatedWLFemale(l, 2);
                                y_plus3 = getInterpolatedWLFemale(l, 3);
                            } else {
                                const median = getMedianWL(l);
                                const sdVal = 0.3 + (l - 45) * 0.023;
                                y_minus3 = median + (-3 * sdVal);
                                y_minus2 = median + (-2 * sdVal);
                                y_plus1 = median + (1 * sdVal);
    ...
    plugins: [customBgPluginWL, sdLabelsPluginWL]
});
...
const globalToggleSdLines = document.getElementById('globalToggleSdLines');
if (globalToggleSdLines) {
    globalToggleSdLines.addEventListener('change', function() {
        const isChecked = this.checked;
        const charts = [
            typeof weightChart !== 'undefined' ? weightChart : null,
            typeof heightChart !== 'undefined' ? heightChart : null,
            typeof headCircumferenceChart !== 'undefined' ? headCircumferenceChart : null,
            typeof weightLengthChart !== 'undefined' ? weightLengthChart : null,
            typeof bmiChart !== 'undefined' ? bmiChart : null,
            typeof weightChart2460 !== 'undefined' ? weightChart2460 : null,
            typeof heightChart2460 !== 'undefined' ? heightChart2460 : null,
            typeof weightHeightChart2460 !== 'undefined' ? weightHeightChart2460 : null,
            typeof bmiChart2460 !== 'undefined' ? bmiChart2460 : null
        ];
        ...
        charts.forEach(chart => {
            if (chart) {
                chart.data.datasets.forEach((dataset, i) => {
                    if (dataset.label && dataset.label.startsWith('SD ')) {
                        chart.setDatasetVisibility(i, isChecked);
                    }
                });
                chart.update();
            }
...
document.addEventListener('DOMContentLoaded', function() {
    const childAge = {{ $child->ageMonths() }};
    const toggleAll = document.getElementById('toggleAllAgeCharts');
    
    // Find all chart wrappers (col-lg-12)
    const chartContainers = document.querySelectorAll('#chartContainersWrapper > .col-lg-12');
    const charts25 = [];
    
    chartContainers.forEach(container => {
        const h2 = container.querySelector('h2');
        if (h2 && (h2.textContent.includes('2 - 5 Tahun') || h2.textContent.includes('2-5 Tahun'))) {
            charts25.push(container);
        }
    });

    function updateVisibility() {
        if (childAge >= 24) {
            // If child is >= 24 months, 2-5 charts are always visible automatically
            charts25.forEach(el => el.classList.remove('d-none'));
            if (toggleAll) {
                toggleAll.checked = true;
                toggleAll.disabled = true;
            }
        } else {
            // If child is < 24 months, 2-5 charts depend on the toggle
            if (toggleAll && toggleAll.checked) {
                charts25.forEach(el => el.classList.remove('d-none'));
            } else {
                charts25.forEach(el => el.classList.add('d-none'));
            }
        }
    }

    if (toggleAll) {
        toggleAll.addEventListener('change', updateVisibility);
    }
