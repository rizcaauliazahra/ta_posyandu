<div class="row g-4 mb-4">
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="hc-wrap" style="min-width: 900px; height: 650px;"><canvas id="headCircumferenceChart"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="w-wrap" style="min-width: 900px; height: 650px;"><canvas id="weightChart"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="h-wrap" style="min-width: 900px; height: 650px;"><canvas id="heightChart"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="wl-wrap" style="min-width: 900px; height: 650px;"><canvas id="weightLengthChart"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="bmi-wrap" style="min-width: 900px; height: 650px;"><canvas id="bmiChart"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="w2-wrap" style="min-width: 900px; height: 650px;"><canvas id="weightChart2460"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="h2-wrap" style="min-width: 900px; height: 650px;"><canvas id="heightChart2460"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="wh2-wrap" style="min-width: 900px; height: 650px;"><canvas id="weightHeightChart2460"></canvas></div></div>
    </div></div></div>
    <div class="col-lg-12"><div class="card border-0 shadow-sm"><div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
            <h2 class="h6 mb-0">
        ...
        <div style="overflow-x: auto; overflow-y: hidden;"><div id="bmi2-wrap" style="min-width: 900px; height: 650px;"><canvas id="bmiChart2460"></canvas></div></div>
    </div></div></div>
</div>
<div class="card border-0 shadow-sm mt-4">
    <div class="card-body">
        <h2 class="h6 mb-3">Measurement Terbaru</h2>
        <div class="table-responsive">
            <table class="table table-bordered align-middle">
                <thead><tr><th>Nama Anak</th><th>Jenis Kelamin</th><th>Tanggal</th><th>Usia (Bulan)</th><th>Berat</th><th>Tinggi</th><th>Lingkar Kepala</th></tr></thead>
                <tbody>
                @forelse($latestMeasurement as $row)
                    <tr><td>{{ $row->child->name }}</td><td>{{ $row->child->gender === 'male' ? 'Laki-laki' : 'Perempuan' }}</td><td>{{ $row->measurement_date->format('d/m/Y') }} {{ substr($row->measurement_time,0,5) }}</td><td>{{ $row->age_months }}</td><td>{{ $row->weight }} kg</td><td>{{ $row->height }} cm</td><td>
                        @if($row->head_circumference !== null)
                            {{ $row->head_circumference }} cm
                        @else
                            -
                        @endif
                    </td></tr>
...
const getInterpolatedWeightFemale = (m, sdValue) => {
...
const getInterpolatedHeightFemale = (m, sdValue) => {
    let sdIndex = 3;
    if (sdValue === -3) sdIndex = 1;
    else if (sdValue === -2) sdIndex = 2;
    else if (sdValue === 0) sdIndex = 3;
...
const getInterpolatedWLFemale = (l, sdValue) => {
...
if (isFemale) {
    ...
    const getInterpolatedBmiFemale = (m, sdValue) => {
        let sdIndex = sdValue + 4;
    ...
    const getInterpolatedBmiMale = (m, sdValue) => {
        let sdIndex = sdValue + 4;
...
if (isFemale) {
    ...
    sdsW2.forEach(sd => {
        ...
        for (let m = 24; m <= 60; m++) {
            ...
            data.push({ x: m, y: getMedianW2(m) + (sd.value * sdVal) });
        }
        sdDatasetsW2.push({
            label: `SD ${sd.label}`,
            data: data,
...
if (isFemale) {
    ...
    sdsH2.forEach(sd => {
        ...
        for (let m = 24; m <= 60; m++) {
            ...
            data.push({ x: m, y: getMedianH2(m) + (sd.value * sdVal) });
        }
        sdDatasetsH2.push({
            label: `SD ${sd.label}`,
            data: data,
...
if (isFemale) {
    ...
    sdsWH2.forEach(sd => {
        ...
        for (let l = 65; l <= 120; l++) {
            ...
            data.push({ x: l, y: getMedianWH2(l) + (sd.value * sdVal) });
        }
        sdDatasetsWH2.push({
            label: `SD ${sd.label}`,
            data: data,
...
if (isFemale) {
    ...
    const getInterpolatedBmiFemale2 = (m, sdValue) => {
        let sdIndex = sdValue + 4;
    ...
    const getInterpolatedBmiMale2 = (m, sdValue) => {
        let sdIndex = sdValue + 4;
